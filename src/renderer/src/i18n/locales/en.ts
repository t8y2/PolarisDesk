export default {
  ...
  chatInput: {
    ...
    personaCleared: 'Persona cleared',
    personaActivated: 'Switched to: {name}',
    managePersonas: '⚙️ Manage Personas'
  },
  media: {
  ...
  settings: {
    ...
    // Persona presets
    personaPresetsTab: 'Persona Presets',
    personaPresets: 'Persona Presets',
    personaPresetsDesc: 'Quickly switch between different AI personas and roles',
    activePersona: 'Active Persona',
    noActivePersona: 'None (Using custom prompt)',
    ...
    activatePersona: 'Use This Persona',
    deactivatePersona: 'Deactivate',
    personaNamePlaceholder: 'e.g.: Programming Expert',
    personaDescPlaceholder: 'Brief description of this persona',
    personaPromptPlaceholder: 'Enter detailed persona prompt...',
    confirmDeletePersona: 'Confirm Delete Persona',
    confirmDeletePersonaContent: 'Are you sure you want to delete persona "{name}"? This action cannot be undone.',
    personaAdded: 'Persona added',
    personaUpdated: 'Persona updated',
    personaDeleted: 'Persona deleted',
    personaActivated: 'Switched to persona: {name}',
    personaDeactivated: 'Persona deactivated, using custom prompt',
    personaNameRequired: 'Please enter persona name',
    personaPromptRequired: 'Please enter persona prompt',
    personaActiveHint: 'Persona active, custom prompt disabled',
