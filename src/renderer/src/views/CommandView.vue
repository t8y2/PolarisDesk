<template>
  <div class="command-view">
    ...
    <div v-if="commandError" class="command-error">
      ...
      <n-code :code="commandError" language="text" />
    </div>
  </div>
</template>
...
import { useMessage, useDialog, NInput, NButton, NButtonGroup, NCode, NTag, NCollapse, NCollapseItem } from 'naive-ui'
...
.command-input-area :deep(.n-input) {
  flex: 1;
}
